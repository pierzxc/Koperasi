...
{          
    if($_POST['action']=="login")
    {
        ...
        $strSQL = mysqli_query($connection,"select username from users where username='".$username."' and password='".md5($password)."'");
        if (!$strSQL) {
    ...
    elseif($_POST['action']=="signup")
    {
        ...
        {
            mysqli_query($connection,"insert into users(username,email,password) values('".$name."','".$email."','".md5($password)."')");
...
<!--form-stars-here-->
		<div class="form-w3-agile">
			...
			<form action="#" method="post">
				...
				<p class="p-bottom-w3ls">Pengguna Baru?<a class="w3_play_icon1" href="#small-dialog1">  Daftar Disini</a></p>
